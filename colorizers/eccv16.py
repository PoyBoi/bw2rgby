...
class ECCVGenerator(BaseColor):
    def __init__(self, norm_layer=nn.BatchNorm2d):
        ...
        #!TODO uses RELU, see if anything better can work here
        ...
        #!TODO See why it uses 313 instead of the usual 512, and why are stopping at 8 layers, why not >, <
        ...
        #!TODO check if there is a better model than softmax to use for normalization
        #!TODO also check if altering the scale factor makes any difference, and same for bilinear mode
    ...
    # Sets up a forward pass, does the iteration part and calls nmlz and unmlz from the base color file
